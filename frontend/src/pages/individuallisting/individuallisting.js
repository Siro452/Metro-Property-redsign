...
import maplisting from "../../assets/maplisting.png"
 ...
 export default function IndividualListing() {
    ...
    const bullets = ["Partially Furnished", "Pet friendly", "Power and internet included", "Move in cost $1000, two weeks bond"]
                    ...
                    <div className={styles.bodyandaside}>
                        <div className={styles.textinfo}>
                            ...
                            <div className={styles.featurebtns}>
                                <ListingMainFeaturesBlue image={bed} text={`${bedrooms} Beds`}/>
                                <ListingMainFeaturesBlue image={bath} text={`${bathrooms} Bath`}/>
                                <ListingMainFeaturesBlue image={pet} text={"Pet Friendly"}/>
                                <ListingMainFeaturesBlue image={bus} text={`${publictransport} mins to public transport`}/>
                            </div>
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi sagittis nunc vel libero consequat laoreet. Aliquam venenatis nec ipsum non ornare. Suspendisse sagittis rutrum felis, quis fringilla tellus mollis ut. Duis ultricies egestas felis, id ullamcorper libero. Morbi tincidunt varius neque, in congue ligula fringilla vel. Aliquam erat volutpat. Morbi nec risus ut dui consectetur malesuada a sit amet diam. Ut elementum mauris vitae neque porttitor ultrices. Nam molestie dignissim viverra. Aliquam faucibus risus tempus enim fermentum, a tincidunt magna iaculis. Vestibulum a scelerisque nisi. Pellentesque tincidunt tellus eu elementum dictum. Morbi eget finibus dolor.</p>
                        </div>
